  ...
  List<DuaasList> get dailyDuaas {
    return [
      ...
      DuaasList(
        ...
        r: 'Text of Quran, Sura 14: Saffat (Those who rank themselves in Order)\n\nVerse 35                                           ',
      ),
      DuaasList(
  ...
  List<DuaasList> get beforeStudyingDuaas {
    return [
      ...
      DuaasList(
          ...
          tr: 'Oh Allah! I ask you for the understanding of the prophets and the memory of the messengers, and those nearest to you.',
          r: 'i'),
      DuaasList(
